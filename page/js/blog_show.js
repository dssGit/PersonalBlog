var blogShow = new Vue({
    ...
    created () {
        ...
        axios({
            ...
            blogShow.title = result.title
            blogShow.content = result.content
            blogShow.tags = result.tags
            blogShow.ctime = result.ctime
            blogShow.views = result.views
        }).catch(function () {
            console.log("请求失败")
        })
    }
